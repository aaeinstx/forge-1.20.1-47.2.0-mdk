...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(ModItems.ALUMINUM_SWORD);
        handheldItem(ModItems.ALUMINUM_PICKAXE);
        handheldItem(ModItems.ALUMINUM_AXE);
        handheldItem(ModItems.ALUMINUM_SHOVEL);
        handheldItem(ModItems.ALUMINUM_HOE);
        handheldItem(ModItems.COMPOUND_BOW);

        trimmedArmorItem(ModItems.ALUMINUM_HELMET);
        trimmedArmorItem(ModItems.ALUMINUM_CHESTPLATE);
        trimmedArmorItem(ModItems.ALUMINUM_LEGGINGS);
        trimmedArmorItem(ModItems.ALUMINUM_BOOTS);
        ...
        private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
            final String MOD_ID = IspMod.MODID; // Change this to your mod id
